...
from target_algolia.sinks import (AlgoliaSink)
...
class TargetAlgolia(Target):
    ...
    config_jsonschema = th.PropertiesList(
        ...
        th.Property(
            ...
            th.StringType,
            description=
            "Algolia API key with following permissions: addObject, deleteObject, editSettings",
            required=True),
        th.Property("index_mapping_file",
                    th.StringType,
